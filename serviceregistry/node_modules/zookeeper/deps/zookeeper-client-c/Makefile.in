...
am__depfiles_remade = ./$(DEPDIR)/addrvec.Plo ./$(DEPDIR)/cli.Po \
	...
	./$(DEPDIR)/zk_log.Plo ./$(DEPDIR)/zk_sasl.Plo \
	./$(DEPDIR)/zktest_mt-LibCMocks.Po \
	...
	./$(DEPDIR)/zktest_mt-TestSASLAuth.Po \
	...
	./$(DEPDIR)/zktest_st-TestSASLAuth.Po \
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libzkmt_la-zk_sasl.Plo@am__quote@ # am--include-marker
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zk_sasl.Plo@am__quote@ # am--include-marker
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestSASLAuth.Po@am__quote@ # am--include-marker
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestSASLAuth.Po@am__quote@ # am--include-marker
...
distclean: distclean-am
	...
	-rm -f ./$(DEPDIR)/libzkmt_la-zk_sasl.Plo
	...
	-rm -f ./$(DEPDIR)/zktest_mt-TestSASLAuth.Po
	...
	-rm -f ./$(DEPDIR)/zktest_st-TestSASLAuth.Po
